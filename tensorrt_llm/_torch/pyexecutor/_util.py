...
def get_kv_cache_manager_cls(
    ...
    if is_hybrid_linear(config):
        ...
        # Preserve Kimi K3's compatibility-manager routing when V2 is
        # explicitly disabled. Its KDA speculative path uses Mixed without
        # block reuse and the unified C++ pool when reuse is enabled.
